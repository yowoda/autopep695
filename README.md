...
You can also specify the `--silent` (`-s`) flag that silences the errors logged and only shows the number of errors reported. Add the `--report-assignments` flag to enable type parameter assignment reports. 
